...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="accueil.jsp"> <img alt="Charisma Logo" src="img/logo20.png" class="hidden-xs"/>
...
<tr>
<td> login </td>
<td> <input type="text" class="form-control" name="login" value="<% if(rs.next())
 out.print(rs.getString("login"));  %>" > </td>
</tr>
<tr>
<td> mot de passe </td>
...
<tr>
    <td colspan="2" align="center"> <center><input type="submit" class="btn btn-success" value="modifier"> </center>    </td>
</tr>
</table>                <input type="Hidden" name="page" value="pr">
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://fb.com/abdelhak.blidaoui.3" target="_blank">abdelhak
            </a> </p>
    </footer>

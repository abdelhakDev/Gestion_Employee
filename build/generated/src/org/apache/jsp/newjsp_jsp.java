...
System.out.println("la connexion a reussie");
 PreparedStatement pst; 
   ...
   pst.executeQuery(); 
      ...
      out.write("                <form name=\"f\" action=\"servl\" method=\"GET\">\n");
      out.write("<table class=\"table table-responsive\">\n");
      out.write("\n");
      out.write("\n");
      out.write("<tr>\n");
      out.write("<td> salaire </td>\n");
      out.write("<td> <input type=\"text\" class=\"form-control\" name=\"salaire\" value=\"");
 if(rs.next())
{out.print(rs.getString("salaire"));}  
      out.write("\" > </td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("<td> grade </td>\n");
      out.write("<td> <input type=\"text\" class=\"form-control\" name=\"grade\" value=\"");
 if(rs.next())
{out.print(rs.getString("grade"));}  
      ...
      out.write("\n");
      out.write("\n");
      out.write("</table>                <input type=\"Hidden\" name=\"supu\" value=\"pr\">\n");
      out.write("\n");
      out.write("             \n");
      out.write("</form>\n");
      out.write("\n");
      ...
      out.write("        <button type=\"f.submit()\" class=\"btn btn-primary\">modifier</button>\n");
      out.write("      </div>\n");
      out.write("    </div>\n");
      out.write("  </div>\n");
      out.write("</div>\n");

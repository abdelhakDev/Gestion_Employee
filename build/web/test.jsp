...
System.out.println("la connexion a reussie");
 PreparedStatement pst; 
   pst = (PreparedStatement) conn.prepareStatement("SELECT * FROM `user` WHERE `id`='"+1+"'"); 
   pst.executeQuery(); 
...
<tr>
<td> login </td>
<td> <input type="text" class="form-control" name="login" value="<% rs.getString("login");  %>" placeholder=" ...."> </td>
</tr>
<tr>
<td> mot de passe </td>
